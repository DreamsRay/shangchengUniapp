<template>
	<view>
		<view class="goods-section" v-for="item in orderData.order_goods">
			<!-- 商品列表 -->
			<view class="g-item">
				...
				<view class="right">
					...
					<view class="price-box">
						<view>
							...
							<text class="fake-price">￥{{item.fake_price}}</text>
						</view>
						<view>
							<!-- <text class="price">￥{{item.price}}</text> -->
							<text class="price">x {{item.amount}}</text>
						</view>
					</view>
				</view>
			</view>
		...
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				...
				<text class="cell-tip">￥{{orderData.money}}</text>
			</view>
			<view class="yt-list-cell b-b">
		...
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				...
				<text class="cell-tip">{{orderData.number}}</text>
			</view>
			<view class="yt-list-cell b-b">
		...
		<view class="footer">
			<view class="price-content">
				...
				<text class="price">{{orderData.pay_money}}</text>
			</view>
			<orderBtn @returnDate="returnDate" v-if="orderData.status == 'unpaid'" :orderId="orderData.id"></orderBtn>
		</view>
	</view>
</template>
